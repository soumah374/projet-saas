...
makemigrations:
	...
	docker compose exec backend python manage.py makemigrations users teams projects documents notifications catalog devis contrats billings dashboard email_templates app_config logistics
