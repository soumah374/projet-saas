...
from .views import UserViewSet, CustomTokenObtainPairView, AuthViewSet, ClientProfileViewSet, ClientUserCreateViewSet
...
router.register(r'clients-create', ClientUserCreateViewSet, basename='client-create')
